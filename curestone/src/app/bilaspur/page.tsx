...
export const metadata: Metadata = {
  ...
  description: "Advanced laser treatment starting from ₹55,000. Experience USFDA approved technology with Bilaspur's top-tier urologists.",
  alternates: {
          ...
          <div className="max-w-7xl mx-auto px-8 grid grid-cols-1 lg:grid-cols-12 gap-16 items-center relative z-10">
            <div className="lg:col-span-7">
              ...
              <p className="text-xl text-slate-600 leading-relaxed max-w-2xl mb-12">
                Advanced laser treatment starting from <span className="text-blue-900 font-bold text-3xl block lg:inline mt-2 lg:mt-0">₹55,000</span>. Experience USFDA approved technology with Bilaspur&apos;s top-tier urologists.
              </p>
        ...
        <section className="py-20 max-w-7xl mx-auto px-8">
          <div className="editorial-gradient rounded-[3rem] p-12 lg:p-20 text-center relative overflow-hidden">
            <div className="relative z-10">
              ...
              <p className="text-blue-100 text-xl max-w-2xl mx-auto mb-12 opacity-90">Join 5000+ happy patients in Bilaspur. Book your first clinical consultation with our experts today.</p>
