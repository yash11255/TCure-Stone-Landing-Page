...
export const metadata: Metadata = {
  title: "Kidney Stone Surgery Cost in Bilaspur | CureStone",
  description: "Advanced laser treatment starting from ₹58,000. Experience USFDA approved technology with Bilaspur's top-tier urologists.",
  alternates: {
    canonical: "https://curestone.in/bilaspur",
  },
  openGraph: {
    title: "Kidney Stone Surgery Cost in Bilaspur | CureStone",
    description: "Advanced laser treatment starting from ₹58,000. Experience USFDA approved technology with Bilaspur's top-tier urologists.",
    url: "https://curestone.in/bilaspur",
    siteName: "CureStone",
    images: [{ url: "/og-image.svg", width: 1200, height: 630, alt: "Kidney Stone Surgery Cost in Bilaspur | CureStone" }],
    locale: "en_IN",
    type: "website",
  },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      "@type": "ListItem",
      position: 2,
      name: "Kidney Stone Surgery Bilaspur",
      item: "https://curestone.in/bilaspur",
    },
  ],
};
...
const localBusinessSchema = {
  ...
  name: "CureStone – Kidney Stone Surgery Bilaspur",
  description: "Advanced RIRS laser kidney stone surgery serving patients from Bilaspur. No cuts, 98% success rate.",
  url: "https://curestone.in/bilaspur",
...
export default function BilaspurSurgeryPage() {
  return (
          ...
          <div className="max-w-7xl mx-auto px-8 grid grid-cols-1 lg:grid-cols-12 gap-16 items-center relative z-10">
            <div className="lg:col-span-7">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-amber-100 text-amber-900 text-xs font-bold uppercase tracking-widest mb-6">
                <span className="material-symbols-outlined text-sm">location_on</span> Bilaspur Clinical Excellence
              </div>
              <h1 className="font-sans text-5xl lg:text-7xl font-extrabold text-blue-900 leading-tight tracking-tighter mb-8">
                Kidney Stone Surgery <br />Cost in <span className="text-amber-600">Bilaspur</span>
              </h1>
              <p className="text-xl text-slate-600 leading-relaxed max-w-2xl mb-12">
                Advanced laser treatment starting from <span className="text-blue-900 font-bold text-3xl block lg:inline mt-2 lg:mt-0">₹58,000</span>. Experience USFDA approved technology with Bilaspur&apos;s top-tier urologists.
              </p>
            ...
            <div className="lg:col-span-5">
              <div className="bg-white p-8 lg:p-10 rounded-[2rem] ambient-shadow border border-slate-200">
                ...
                <p className="text-slate-600 text-sm mb-8">Personalized cost breakdown for Bilaspur residents</p>
                <LocationLeadForm locationName="Bilaspur" />
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-8">
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
              <div className="max-w-2xl">
                <h2 className="font-sans text-4xl lg:text-5xl font-bold text-blue-900 tracking-tight mb-6">Why Choose <span className="text-amber-600">CureStone</span> in Bilaspur?</h2>
        ...
        <section className="py-20 max-w-7xl mx-auto px-8">
          <div className="editorial-gradient rounded-[3rem] p-12 lg:p-20 text-center relative overflow-hidden">
            <div className="relative z-10">
              ...
              <p className="text-blue-100 text-xl max-w-2xl mx-auto mb-12 opacity-90">Join 9000+ happy patients in Bilaspur. Book your first clinical consultation with our experts today.</p>
