...
export const metadata: Metadata = {
  title: "Laser vs shockwave treatment for kidney stones – Which works better? | CureStone",
  description: "Kidney stones are hard, tiny particles that may develop in your kidneys. Sometimes kidney stones remain silent and cause no discomfort, but in other cases",
  alternates: {
    canonical: "https://curestone.in/blog/laser-vs-shockwave-treatment-for-kidney-stones-which-works-better",
  },
  openGraph: {
    title: "Laser vs shockwave treatment for kidney stones – Which works better? | CureStone",
    description: "Kidney stones are hard, tiny particles that may develop in your kidneys. Sometimes kidney stones remain silent and cause no discomfort, but in other cases",
    url: "https://curestone.in/blog/laser-vs-shockwave-treatment-for-kidney-stones-which-works-better",
    siteName: "CureStone",
    images: [{ url: "/og-image.svg", width: 1200, height: 630, alt: "Laser vs shockwave treatment for kidney stones – Which works better? | CureStone" }],
    locale: "en_IN",
    type: "website",
  },
};
...
const blogSchema = {
  ...
  "@type": "BlogPosting",
  headline: "Laser vs shockwave treatment for kidney stones – Which works better? | CureStone",
  description: "Kidney stones are hard, tiny particles that may develop in your kidneys. Sometimes kidney stones remain silent and cause no discomfort, but in other cases",
  image: "https://curestone.in/blogs/laser-vs-shockwave-treatment-for-kidney-stones-which-works-better.png",
  url: "https://curestone.in/blog/laser-vs-shockwave-treatment-for-kidney-stones-which-works-better",
  ...
  mainEntityOfPage: {
    "@type": "WebPage",
    "@id": "https://curestone.in/blog/laser-vs-shockwave-treatment-for-kidney-stones-which-works-better",
  },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      "@type": "ListItem",
      position: 3,
      name: "Laser vs shockwave treatment for kidney stones – Which works better? | CureStone",
      item: "https://curestone.in/blog/laser-vs-shockwave-treatment-for-kidney-stones-which-works-better",
    },
  ],
};
        ...
        <section className="relative overflow-hidden py-20 lg:py-28 bg-slate-50">
          <div className="max-w-4xl mx-auto px-8 text-center">
            ...
            <h1 className="font-sans text-4xl lg:text-6xl font-extrabold text-blue-900 leading-tight tracking-tighter mb-6">
              Laser vs shockwave treatment for kidney stones – Which works better?
            </h1>
            <p className="text-xl text-slate-600 max-w-2xl mx-auto mb-8">
              Kidney stones are hard, tiny particles that may develop in your kidneys. Sometimes kidney stones remain silent and cause no discomfort, but in other cases
            </p>
            <a
              href="https://thecurestone.com/kidney/laser-vs-shockwave-treatment-for-kidney-stones-which-works-better/"
              target="_blank"
