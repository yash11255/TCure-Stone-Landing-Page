...
export const metadata: Metadata = {
  title: "Best Kidney Stone Surgery in Sector 69, Gurgaon | Laser Treatment & RIRS Experts",
  description: "Consult top urologists in Sector 69, Gurgaon for advanced laser kidney stone removal. Minimal invasive RIRS, PCNL, and ESWL procedures with 24-hour recovery and cashless insurance.",
  alternates: {
    canonical: "https://curestone.in/sector-69",
  },
  openGraph: {
    title: "Best Kidney Stone Surgery in Sector 69, Gurgaon | Laser Treatment & RIRS Experts",
    description: "Consult top urologists in Sector 69, Gurgaon for advanced laser kidney stone removal. Minimal invasive RIRS, PCNL, and ESWL procedures with 24-hour recovery and cashless insurance.",
    url: "https://curestone.in/sector-69",
    siteName: "CureStone",
    images: [{ url: "/og-image.svg", width: 1200, height: 630, alt: "Best Kidney Stone Surgery in Sector 69, Gurgaon | Laser Treatment & RIRS Experts" }],
    locale: "en_IN",
    type: "website",
  },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      "@type": "ListItem",
      position: 2,
      name: "Kidney Stone Surgery Sector 69 Gurgaon",
      item: "https://curestone.in/sector-69",
    },
  ],
};
...
const localBusinessSchema = {
  ...
  name: "CureStone – Kidney Stone Surgery Sector 69 Gurgaon",
  description: "Advanced RIRS laser kidney stone surgery serving patients from Sector 69 Gurgaon. No cuts, 98% success rate.",
  url: "https://curestone.in/sector-69",
  ...
  areaServed: "Sector 69 Gurgaon",
  medicalSpecialty: "Urology",
};

export default function Sector69SurgeryPage() {
  return (
      ...
      <main className="flex-grow pt-20">
          ...
          <div className="max-w-7xl mx-auto px-8 grid grid-cols-1 lg:grid-cols-12 gap-16 items-center relative z-10">
            <div className="lg:col-span-7">
              ...
              <h1 className="font-sans text-5xl lg:text-7xl font-extrabold text-blue-900 leading-tight tracking-tighter mb-8">
                Best <span className="text-amber-600">Laser Kidney Stone</span> Treatment in Sector 69, Gurgaon
              </h1>
            ...
            <div className="lg:col-span-5">
              <div className="bg-white p-8 lg:p-10 rounded-[2rem] ambient-shadow border border-slate-200">
                ...
                <p className="text-slate-600 text-sm mb-8">Book an appointment with Sector 69, Gurgaon&apos;s senior urology consultants.</p>
                <LocationLeadForm locationName="Sector 69" />
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-24 bg-white">
          <div className="max-w-7xl mx-auto px-8">
            <div className="mb-16">
              <h2 className="font-sans text-4xl lg:text-5xl font-bold text-blue-900 tracking-tight mb-6">Painless Kidney Stone Treatment Options in <span className="text-amber-600">Sector 69, Gurgaon</span></h2>
              <p className="text-lg text-slate-600 max-w-4xl">
                Our Sector 69, Gurgaon-based urology centers offer comprehensive care for renal stones, ureteric stones, and bladder stones. By utilizing **USFDA-approved Thulium Fiber Laser (TFL)** and **Holmium:YAG technology**, we ensure patients experience minimal blood loss and the fastest recovery times in the industry.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-slate-50 p-10 rounded-[2.5rem] border border-transparent hover:border-blue-200 transition-all">
                ...
                <p className="text-slate-600 leading-relaxed">The most advanced **Retrograde Intrarenal Surgery** in Sector 69, Gurgaon. No cuts, no scars—ideal for stones located deep within the kidney. Complete discharge within 24 hours.</p>
              </div>
              ...
              <div className="bg-slate-50 p-10 rounded-[2.5rem] border border-transparent hover:border-blue-200 transition-all">
                ...
                <p className="text-slate-600 leading-relaxed">Specialized treatment for **Large Staghorn Stones** (20mm). Our Sector 69, Gurgaon urologists use ultra-miniature scopes for faster healing compared to traditional open surgery.</p>
              </div>
          ...
          <div className="editorial-gradient rounded-[3rem] p-12 lg:p-20 text-center relative overflow-hidden">
            <div className="relative z-10">
              ...
              <p className="text-blue-100 text-xl max-w-2xl mx-auto mb-12 opacity-90">
                Join thousands of patients who have successfully undergone laser lithotripsy at our Sector 69, Gurgaon clinics. Consult with a Senior Urologist today.
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                ...
                <a className="text-white flex items-center gap-2 font-sans font-bold text-lg" href="tel:+919876543210">
                  <span className="material-symbols-outlined">call</span> Sector 69, Gurgaon Helpline: +91 98765 43210
                </a>
              </div>
            </div>
            {/* Design accents */}
