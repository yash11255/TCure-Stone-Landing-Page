...
export const metadata: Metadata = {
  title: "Best Kidney Stone Surgery in South City 1, Gurgaon | Laser Treatment & RIRS Experts",
  description: "Consult top urologists in South City 1, Gurgaon for advanced laser kidney stone removal. Minimal invasive RIRS, PCNL, and ESWL procedures with 24-hour recovery and cashless insurance.",
  alternates: {
    canonical: "https://curestone.in/south-city-1",
  },
  openGraph: {
    title: "Best Kidney Stone Surgery in South City 1, Gurgaon | Laser Treatment & RIRS Experts",
    description: "Consult top urologists in South City 1, Gurgaon for advanced laser kidney stone removal. Minimal invasive RIRS, PCNL, and ESWL procedures with 24-hour recovery and cashless insurance.",
    url: "https://curestone.in/south-city-1",
    siteName: "CureStone",
    images: [{ url: "/og-image.svg", width: 1200, height: 630, alt: "Best Kidney Stone Surgery in South City 1, Gurgaon | Laser Treatment & RIRS Experts" }],
    locale: "en_IN",
    type: "website",
  },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      "@type": "ListItem",
      position: 2,
      name: "Kidney Stone Surgery South City 1 Gurgaon",
      item: "https://curestone.in/south-city-1",
    },
  ],
};
...
const localBusinessSchema = {
  ...
  name: "CureStone – Kidney Stone Surgery South City 1 Gurgaon",
  description: "Advanced RIRS laser kidney stone surgery serving patients from South City 1 Gurgaon. No cuts, 98% success rate.",
  url: "https://curestone.in/south-city-1",
  ...
  areaServed: "South City 1 Gurgaon",
  medicalSpecialty: "Urology",
};

export default function SouthCity1SurgeryPage() {
  return (
          ...
          <div className="max-w-7xl mx-auto px-8 grid grid-cols-1 lg:grid-cols-12 gap-16 items-center relative z-10">
            ...
            <div className="lg:col-span-5">
              <div className="bg-white p-8 lg:p-10 rounded-[2rem] ambient-shadow border border-slate-200">
                ...
                <p className="text-slate-600 text-sm mb-8">Book an appointment with South City 1, Gurgaon&apos;s senior urology consultants.</p>
                <LocationLeadForm locationName="South City 1" />
              </div>
            </div>
          </div>
        </section>
